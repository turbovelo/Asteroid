...
A = 1.516661905270592e08 * u.km
EC = 1.084686128924439e-02 * u.one
IN = 3.183372510637163e-03 * u.deg
W = 3.043798594895089e02 * u.deg
OM = 1.710197739423058e02 * u.deg
TA = 1.570207833379229e02 * u.deg
...
re = [-1.378249046368877e02, 1.675263270910506e03, -6.139195868505277e03] * u.km
ve = (
    [-2.901410011378197e-01, -7.604139085540065e-03, 4.438646604511316e-03] * u.km / u.s
)
ra = [-1.449391930783899e08, 9.746148285124145e07, 1.848501659581006e07] * u.km
va = [-1.728374960605640e01, -2.738421095798672e01, -1.409369092272017e00] * u.km / u.s
